...
from .views import index,search,details,borrow,borrow_history, borrow_details, ProfileRegistrationCreateView, school_class_creation, LoginView, LogoutView, SchoolClassDetailView, SchoolClassListView
...
urlpatterns = [
    ...
    path('class', SchoolClassListView.as_view(), name='school_class_list'),
